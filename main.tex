...
\begin{tikzpicture}[remember picture, overlay]
  \node[anchor=north east, inner sep=0pt, xshift=-1.2cm, yshift=-0.4cm]
...
\begin{itemize}
  \item 具备从 VLM 适配、训练加速、Head 架构设计到指标验证的端到端落地能力，熟悉 Qwen3-VL、3.5等系列模型内部机制（M-RoPE、视觉 patch 化、packing 注意力）；关注训练效率与工程化质量，主动推进 packing/flash-attention/混合精度等基础设施优化以缩短迭代周期。
